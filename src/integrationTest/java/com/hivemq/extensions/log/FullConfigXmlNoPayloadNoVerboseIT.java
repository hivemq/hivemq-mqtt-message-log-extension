...
public class FullConfigXmlNoPayloadNoVerboseIT {
    ...
    final @NotNull HiveMQContainer hivemq = new HiveMQContainer(HIVEMQ) //
            ...
            .withFileInExtensionHomeFolder(MountableFile.forClasspathResource("fullConfigNoPayloadNoVerbose.xml"),
    ...
    void test() {
        ...
        client.publishWith()
                ...
                .send();
        await().until(() -> hivemq.getLogs()
                .contains("Received PUBLISH from client 'test-client' for topic 'publish': QoS: '2', Retained: 'false'"));
        ...
        client.publishWith()
                ...
                .send();
        await().until(() -> hivemq.getLogs()
                .contains("Received PUBLISH from client 'test-client' for topic 'publish': QoS: '1', Retained: 'false'"));
