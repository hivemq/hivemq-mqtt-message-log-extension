...
public class DisconnectOutboundInterceptorImpl implements DisconnectOutboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(DisconnectOutboundInterceptorImpl.class);
    ...
    @Override
    public void onOutboundDisconnect(final @NotNull DisconnectOutboundInput disconnectOutboundInput,
                                     final @NotNull DisconnectOutboundOutput disconnectOutboundOutput) {
        try {
            @NotNull final String clientId = disconnectOutboundInput.getClientInformation().getClientId();
