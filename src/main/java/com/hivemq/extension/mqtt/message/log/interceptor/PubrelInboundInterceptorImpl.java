...
public class PubrelInboundInterceptorImpl implements PubrelInboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(PubrelInboundInterceptorImpl.class);
    ...
    @Override
    public void onInboundPubrel(final @NotNull PubrelInboundInput pubrelInboundInput,
                                final @NotNull PubrelInboundOutput pubrelInboundOutput) {
        try {
            @NotNull final String clientId = pubrelInboundInput.getClientInformation().getClientId();
