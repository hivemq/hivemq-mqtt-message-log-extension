...
public class UnsubscribeInboundInterceptorImpl implements UnsubscribeInboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(UnsubscribeInboundInterceptorImpl.class);
    ...
    @Override
    public void onInboundUnsubscribe(final @NotNull UnsubscribeInboundInput unsubscribeInboundInput,
