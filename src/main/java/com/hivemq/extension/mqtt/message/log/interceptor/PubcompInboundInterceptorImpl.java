...
public class PubcompInboundInterceptorImpl implements PubcompInboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(PubcompInboundInterceptorImpl.class);
    ...
    @Override
    public void onInboundPubcomp(final @NotNull PubcompInboundInput pubcompInboundInput,
                                 final @NotNull PubcompInboundOutput pubcompInboundOutput) {
        try {
            @NotNull final String clientId = pubcompInboundInput.getClientInformation().getClientId();
