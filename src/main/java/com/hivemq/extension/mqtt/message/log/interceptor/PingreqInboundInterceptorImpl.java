...
public class PingreqInboundInterceptorImpl implements PingReqInboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(PingreqInboundInterceptorImpl.class);


    @Override
    public void onInboundPingReq(final @NotNull PingReqInboundInput pingReqInboundInput,
