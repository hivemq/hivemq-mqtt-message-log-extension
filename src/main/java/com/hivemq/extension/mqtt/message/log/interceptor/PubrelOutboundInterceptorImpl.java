...
public class PubrelOutboundInterceptorImpl implements PubrelOutboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(PubrelOutboundInterceptorImpl.class);
    ...
    @Override
    public void onOutboundPubrel(final @NotNull PubrelOutboundInput pubrelOutboundInput,
                                 final @NotNull PubrelOutboundOutput pubrelOutboundOutput) {
        try {
            @NotNull final String clientId = pubrelOutboundInput.getClientInformation().getClientId();
