...
public class SubackOutboundInterceptorImpl implements SubackOutboundInterceptor {
    ...
    @NotNull
    private static final Logger log = LoggerFactory.getLogger(SubackOutboundInterceptorImpl.class);
    ...
    @Override
    public void onOutboundSuback(final @NotNull SubackOutboundInput subackOutboundInput,
