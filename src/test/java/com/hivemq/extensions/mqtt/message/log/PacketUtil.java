...
public class PacketUtil {
    ...
    public static class TestDisconnect implements DisconnectEventInput {
        ...
        @Override
        public @NotNull ClientInformation getClientInformation() {
            return mock(ClientInformation.class);
        }
    }
    ...
    public static class TestUserProperties implements UserProperties {
        ...
        @Override
        public @NotNull Optional<String> getFirst(final @NotNull String s) {
            return Optional.empty();
        }

        @Override
        public @NotNull List<String> getAllForName(final @NotNull String s) {
            return List.of();
        }
