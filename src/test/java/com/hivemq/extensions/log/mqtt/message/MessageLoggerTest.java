...
class MessageLoggerTest {
    ...
    void test_lifecycle_and_interceptor_disconnect_logs_have_same_format() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo(expectedLog);
    ...
    void test_log_lifecycle_disconnect_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received DISCONNECT from client 'clientid': Reason Code: 'BAD_AUTHENTICATION_METHOD', Reason String: 'ReasonString', \
    ...
    void test_log_lifecycle_disconnect_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received DISCONNECT from client 'clientid': Reason Code: 'null', Reason String: 'null', \
    ...
    void test_log_puback_inbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBACK from client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0'], [Name: 'name1', Value: 'value1']""");
    }
    ...
    void test_log_puback_inbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBACK from client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_puback_outbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBACK to client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0'], [Name: 'name1', Value: 'value1']""");
    }
    ...
    void test_log_puback_outbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBACK to client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubrec_inbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBREC from client 'clientid': Reason Code: 'SUCCESS', Reason String: 'Okay', \
    ...
    void test_log_pubrec_inbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBREC from client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubrec_outbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBREC to client 'clientid': Reason Code: 'SUCCESS', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0']""");
    }
    ...
    void test_log_pubrec_outbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBREC to client 'clientid': Reason Code: 'NO_MATCHING_SUBSCRIBERS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubrel_inbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBREL from client 'clientid': Reason Code: 'PACKET_IDENTIFIER_NOT_FOUND', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0']""");
    }
    ...
    void test_log_pubrel_inbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBREL from client 'clientid': Reason Code: 'SUCCESS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubrel_outbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBREL to client 'clientid': Reason Code: 'PACKET_IDENTIFIER_NOT_FOUND', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0']""");
    }
    ...
    void test_log_pubrel_outbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBREL to client 'clientid': Reason Code: 'SUCCESS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubcomp_inbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBCOMP from client 'clientid': Reason Code: 'PACKET_IDENTIFIER_NOT_FOUND', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0']""");
    }
    ...
    void test_log_pubcomp_inbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Received PUBCOMP from client 'clientid': Reason Code: 'SUCCESS', Reason String: 'null', \
                User Properties: 'null'""");
    }
    ...
    void test_log_pubcomp_outbound_verbose_all_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBCOMP to client 'clientid': Reason Code: 'PACKET_IDENTIFIER_NOT_FOUND', Reason String: 'Okay', \
                User Properties: [Name: 'name0', Value: 'value0']""");
    }
    ...
    void test_log_pubcomp_outbound_verbose_none_set() {
        ...
        assertThat(logbackTestAppender.getEvents().getFirst().getFormattedMessage()).isEqualTo("""
                Sent PUBCOMP to client 'clientid': Reason Code: 'SUCCESS', Reason String: 'null', \
                User Properties: 'null'""");
    }
